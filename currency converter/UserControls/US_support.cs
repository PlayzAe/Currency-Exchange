...
{
    public partial class US_support : UserControl
    {
        public US_support()
        {
            InitializeComponent();

            CustomizeBackButton(button1support);

            button1support.Click += Button1support_Click;
        }
        ...
        private void Button1support_Click(object sender, EventArgs e)
        {
            //show panel in Form1
